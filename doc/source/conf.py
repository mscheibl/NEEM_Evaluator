...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join("..", "src", "neem_evaluator")))
...
project = 'NEEM Evaluator'
copyright = '2024, Jonas Dech'
author = 'Jonas Dech'
...
# auto api setup
autoapi_type = 'python'
autoapi_dirs = ['../../src/neem_evaluator']
...
latex_documents = [
    (master_doc, 'evaluator.tex', 'NEEM Evaluator Documentation',
     'Jonas Dech', 'manual'),
]
...
man_pages = [
    (master_doc, 'NEEM Evaluator', 'NEEM Evaluator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NEEM Evaluator', 'NEEM Evaluator Documentation',
     author, 'NEEM Evaluator', 'One line description of project.',
     'Miscellaneous'),
]
